...
namespace ItLabs.MBox.Data
{
    public class DataSeeder
    {
        public static void Seed()
        {
            ...
            context.ApplicationUserRoles.Add(new ApplicationUserRole(RolesEnum.ADMIN));
            context.ApplicationUserRoles.Add(new ApplicationUserRole(RolesEnum.RECORDLABEL));
            context.ApplicationUserRoles.Add(new ApplicationUserRole(RolesEnum.ARTIST));
            context.ApplicationUserRoles.Add(new ApplicationUserRole(RolesEnum.LISTENER));
